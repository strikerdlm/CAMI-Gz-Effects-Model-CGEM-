...
### Additional disclosure — generative AI use

Generative AI tools (Anthropic Claude and OpenAI GPT-class models) were
used during the project for code scaffolding, draft formatting,
reference cross-checking, and editorial review of manuscript drafts. No
AI tool was used to design the study, generate scientific claims,
...
by the human author. AI use is also disclosed in the manuscript
§"Declaration of generative AI use" and in the cover letter.
...
- Short title: 60 characters including spaces. (Wiley short-title
  cap ≤ 70.)
- Abstract: 341 words. (IJNMBE cap ≤ 400.)
